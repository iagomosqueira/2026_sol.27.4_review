...
#_	LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env_var&link	dev_link	dev_minyr	dev_maxyr	dev_PH	Block	Block_Fxn		
	0.1	2.4	1.302	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.754	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.465	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.368	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.321	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.295	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.278	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.267	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.260	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	0.1	2.4	0.248	0.15	0.8	0	 -1	0	0	0	0	0	0	0	#	NatM_p_1_Fem_GP_1 #### 
	...
	-3	4	3.05	3.0962	0.8	0	-99	0	0	0	0	0	0	0	#	Wtlen_2_Fem 
	0	6	0.13	2	0.8	0	-99	0	0	0	0	0	0	0	#	Mat50%_Fem
	-5	3	-4.149	-0.25	0.8	0	-99	0	0	0	0	0	0	0	#	Mat_slope_Fem
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
            5            25         17.43        14.494	             2             -6          1          0          0          0          0          0          0          0 # SR_LN(R0)
...
1911   #_last_early_yr_nobias_adj_in_MPD 
1969   #_first_yr_fullbias_adj_in_MPD 
2023   #_last_yr_fullbias_adj_in_MPD 
2024   #_first_recent_yr_nobias_adj_in_MPD 
0.95   #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models) (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
 0.001 1 0.2 0.1 0.1 0 1 # InitF_seas_1_flt_1Fleet
 0.000 1 0.001 0.1 0.1 0 -1 # InitF_seas_1_flt_4Fleet
#2018 2036
# F rates by fleet
...
#-2    10    1    36   -1 0.05    4 0 0 0 0 0 0 0 # Inflection               
#0.1   10    0.81 0.81 -1 0.05    4 0 0 0 0 0 0 0 # Slope                    
#-5    999   999  1    -1 0.05   -3 0 0 0 0 0 0 0 # Retain_A_asymptote_logit_Commercial(1)  
#0     1     0    0    -1 0.05   -3 0 0 0 0 0 0 0 # Male offset To inflection

#BTS
  -1002 3 	-500 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Reference age 0
  -25	25 	 1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 1
  -5 	9 	 0.02 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 2
  -5 	9 	 0.6 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 3
  -5 	9 	 0.02 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 4
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 5
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 6
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 7
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 8
  ...
  #COAST
  -1002 3 	-500 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Reference age 0
  -25	25 	 1 	 -0.0172979 	0.00001 	-6 	 4 	0 0 0 0 0 0 0 # Change to age 1
  -15 	9 	 0.6 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 2
  -15 	15 	 1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 3
  -15 	9 	 0.3 	-1 	-1 	0.01 	  4 	0 0 0 0 0 0 0 # Change to age 4
  -15 	9 	 0.1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 5
  -15 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 6
  -15 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 7
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 8
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 9
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 10
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 11
 ...
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 13
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 14
 #-10 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 15
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 16
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 17
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 18
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 19
 #-5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 20
  ...
  -1002 3 	-500 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Reference age 0
  -25	25 	 1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 1
  -5 	9 	 0.6 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 2
  -5 	15 	 1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 3
  -5 	9 	 0.3 	-1 	-1 	0.01 	  4 	0 0 0 0 0 0 0 # Change to age 4
  -5 	9 	 0.1 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 5
  -5 	9 	 0.0 	-1 	-1 	0.01 	 4 	0 0 0 0 0 0 0 # Change to age 6
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 7
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 8
  -5 	9 	 0.0 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 9
