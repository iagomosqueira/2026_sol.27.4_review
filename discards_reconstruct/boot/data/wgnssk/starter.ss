...
5 # F_report_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Frates); 4=true F for range of ages
 2 6 #_min and max age over which average F will be calculated
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1640700262
